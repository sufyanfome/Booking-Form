...
<div class="service-options-container">
	<div class="service-option">
		...
		<div class="service-option-price">£<?=REGULAR_LUXURY_CLEANING_PRICE?></div>
		<div class="service-option-amount">
			<div class="change-amount decrease-amount">-</div>
			<input type="text" value="2" id="cleaning-hours" class="amount" data-type="hours" name="cleaning-hours" min="2" max="20"><div class="field-desc"> hr</div>
			<div class="change-amount increase-amount">+</div>
		</div>
		<div class="clearfix"></div>
		<div class="notice">Recommended hours - <span id="recommended-hours"></span></div>
	</div>
</div>
